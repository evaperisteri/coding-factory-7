...
public class FindAndMatch {
    public static void main(String[] args) throws Exception{
        ...
        //optional is a class/container for wrapping null. We avoid null pointer exception
        ...
        String strFirst1 = names.stream().filter(name -> name.equals("Bob")).findFirst().orElse(null);
